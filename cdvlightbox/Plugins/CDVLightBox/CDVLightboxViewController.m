...
@implementation CDVLightboxViewController
...
- (void)viewDidLoad
{
	...
	self.refreshBtn.image	= [UIImage imageNamed:[[self class] resolveImageResource:@"CDVLightbox.bundle/but_refresh"]];
	self.backBtn.image		= [UIImage imageNamed:[[self class] resolveImageResource:@"CDVLightbox.bundle/arrow_left"]];
	self.fwdBtn.image		= [UIImage imageNamed:[[self class] resolveImageResource:@"CDVLightbox.bundle/arrow_right"]];
	self.safariBtn.image	= [UIImage imageNamed:[[self class] resolveImageResource:@"CDVLightbox.bundle/compass"]];
